...
func _ready():
	...
	$VBoxContainer/Boomer.button_pressed = Globals.boomer
	#$VBoxContainer/Invert.button_pressed = Globals.inverted
	$VBoxContainer/Vsync.button_pressed = Globals.vsync
	$VBoxContainer/Fullscreen.button_pressed = Globals.fullscreen
